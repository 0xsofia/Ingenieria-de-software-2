...
4. obtener la url del front al correr ngrok , y ponerla en el .env del back, en FRONTEND_BASE_URL y FRONTEND_LOGIN_URL (agregando el /)
...
### Ahora para pagar con mercado pago

####  mejor usar una pestaña de incognito o un usuario de navegador a parte.
#### al pagar iniciar sesion presionando "ingresar con mi cuenta", e ingresar las credenciales:

- Usuario: TESTUSER12141816

- Contraseña: 1Jr4yuilpP
