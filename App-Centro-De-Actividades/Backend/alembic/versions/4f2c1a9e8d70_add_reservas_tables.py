...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_actividad_nombre"), "actividad", ["nombre"], unique=False)
    ...
    op.create_index(op.f("ix_clase_actividad_id"), "clase", ["actividad_id"], unique=False)
    op.create_index(op.f("ix_clase_nivel_id"), "clase", ["nivel_id"], unique=False)
    op.create_index(op.f("ix_clase_profesor_id"), "clase", ["profesor_id"], unique=False)
    op.create_index(op.f("ix_clase_cancha_id"), "clase", ["cancha_id"], unique=False)
    op.create_index(op.f("ix_clase_fecha_clase"), "clase", ["fecha_clase"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_clase_fecha_clase"), table_name="clase")
    op.drop_index(op.f("ix_clase_cancha_id"), table_name="clase")
    op.drop_index(op.f("ix_clase_profesor_id"), table_name="clase")
    op.drop_index(op.f("ix_clase_nivel_id"), table_name="clase")
    op.drop_index(op.f("ix_clase_actividad_id"), table_name="clase")
    op.drop_table("clase")
